(function () {
    ...
    AnnouncementController.$inject = ['$stateParams', '$timeout', '$log', '$uibModal', '$document', '$localStorage', 'ngToast', 'Notification', '_', 'CommentsUtil', 'MarksUtil',
        'LanguageUtil', 'announcementService', 'commentService', 'markService', 'reportingService'];

    function AnnouncementController($stateParams, $timeout, $log, $uibModal, $document, $localStorage, ngToast, Notification, _, CommentsUtil, MarksUtil,
        LanguageUtil, announcementService, commentService, markService, reportingService) {
